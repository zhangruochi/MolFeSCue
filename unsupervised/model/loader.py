        ...
        if self.dataset == 'zinc_standard_agent':
            ...
            for i in range(len(smiles_list)):
                ...
                try:
                    ...
                    continue
        elif self.dataset == 'pep_atlas_uniparc_smiles_30':
            data_smiles_list = []
            data_list = []
...
class SmilesDataset(InMemoryDataset):
    '''
    Customized dataset for smiles list.
    :parm root: root dir, will generate processed file under this dir.
    ...
    def __init__(self,
        ...
        super(SmilesDataset, self).__init__(root, transform, pre_transform, pre_filter)
        self.transform, self.pre_transform, self.pre_filter = transform, pre_transform, pre_filter
        self.process()
    ...
    def process(self):
        ...
        index_list = list(range(len(self.smiles_list)))
